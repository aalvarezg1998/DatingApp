...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        private readonly ITokenService __serviceToken;
        public AccountController(DataContext context, ITokenService _serviceToken) 
        {
            __serviceToken = _serviceToken;
            _context = context;
        }
        ...
        {   
            ...
            return new UserDto{
                ...
                Token = __serviceToken.CreateToken(user)
            };
        }
